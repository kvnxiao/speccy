...
- [Lints and formatting](references/rust-lints-and-formatting.md): Read when configuring or responding to rustfmt, clippy, lint levels, CI checks, and style rules.
