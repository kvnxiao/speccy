...
```
<verdict persona="style" verdict="pass|blocking" model="<your-model>" rationale="<one line>" />
```

- `persona` — your persona name (`style`).
...
The CLI wraps this body in the `<review persona="style"
