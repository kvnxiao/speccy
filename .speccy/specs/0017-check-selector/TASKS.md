---
spec: SPEC-0017
spec_hash_at_generation: 5b75cb97db93558f50bdb340273cb137381e8aa137f5ed527a79fbef89b2cc93
generated_at: 2026-05-15T00:50:17Z
---
...
- [x] **T-001**: Add the `check_selector` module with `parse_selector`
  - Covers: REQ-001
  - Tests to write:
...
- [x] **T-002**: Wire `parse_selector` into `check::run`; preserve `All` and bare `CHK-NNN`
...
- [x] **T-003**: Implement `CheckSelector::Spec`; tests for spec-scoped execution
  - Covers: REQ-002
  - Tests to write (added to `speccy-cli/tests/check.rs`; test names
...
- [x] **T-004**: Implement `CheckSelector::QualifiedCheck`; tests guard bare-form preservation
  - Covers: REQ-004
  - Tests to write (added to `speccy-cli/tests/check.rs`; test names
...
- [x] **T-005**: Implement `CheckSelector::Task`; tests for task-scoped execution
  - Covers: REQ-003
  - Tests to write (added to `speccy-cli/tests/check.rs`; test names
...
- [x] **T-006**: Update `.speccy/ARCHITECTURE.md` and audit shipped skill docs
  - Covers: REQ-005
  - Tests to write:
