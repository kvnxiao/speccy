...
- [x] **T-001**: Add `minijinja = "2"` to workspace dependencies (session-T001, 2026-05-14)
  - Covers: REQ-006
  - Tests to write:
...
- [x] **T-002**: Relocate shared personas and prompts into `resources/modules/` (session-T002, 2026-05-14)
  - Covers: REQ-001
  - Tests to write:
...
- [x] **T-003**: Author `resources/modules/skills/speccy-<verb>.md` bodies (session-T003, 2026-05-14)
...
- [x] **T-004**: Extend `HostChoice` with `install_roots` and `template_context` (session-T004, 2026-05-14)
  - Covers: REQ-002
  - Tests to write:
...
- [x] **T-005**: Create Claude Code SKILL.md wrappers under `resources/agents/.claude/skills/` (session-T005, 2026-05-14)
  - Covers: REQ-001, REQ-002
  - Tests to write:
...
- [x] **T-006**: Create Codex SKILL.md wrappers under `resources/agents/.agents/skills/` (session-T006, 2026-05-14)
  - Covers: REQ-001, REQ-002
  - Tests to write:
    - When the embedded bundle is walked, then exactly seven files
...
- [x] **T-007**: Wire MiniJinja rendering into `speccy init` (session-T007, 2026-05-14)
...
- [x] **T-008**: Delete the legacy `skills/` tree (session-T008, 2026-05-14)
  - Covers: REQ-001
  - Tests to write:
    - When the workspace tree is walked, then no path matches
...
- [x] **T-009**: Create Claude Code reviewer subagent wrappers (session-T009, 2026-05-14)
  - Covers: REQ-003
  - Tests to write:
...
- [x] **T-010**: Create Codex reviewer subagent wrappers (session-T010, 2026-05-14)
  - Covers: REQ-003
  - Tests to write:
    - When the embedded bundle is walked, then exactly six files
...
- [x] **T-011**: Diverge `speccy-review` step 4 per host
  - Covers: REQ-004
  - Tests to write:
...
- [x] **T-012**: Update CI workflow with dual-host materialization check
  - Covers: REQ-005
  - Tests to write:
...
- [x] **T-013**: Refresh dogfooded host outputs and verify byte-identity
