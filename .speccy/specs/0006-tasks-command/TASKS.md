...
- [ ] **T-001**: Implement SPEC-ID parsing and spec-directory lookup
  ...
  - Suggested files: `crates/speccy/src/tasks.rs`, `crates/speccy/tests/tasks_args.rs`
...
- [ ] **T-002**: Detect initial form (TASKS.md absent) and render `tasks-generate.md`
  ...
  - Suggested files: `crates/speccy/src/tasks.rs` (extend), `skills/shared/prompts/tasks-generate.md` (stub), `crates/speccy/tests/tasks_initial.rs`
...
- [ ] **T-003**: Render `tasks-amend.md` when TASKS.md is present
  ...
  - Tests to write:
    ...
    - Output goes to stdout; exit code 0.
  - Suggested files: `crates/speccy/src/tasks.rs` (extend), `skills/shared/prompts/tasks-amend.md` (stub), `crates/speccy/tests/tasks_amendment.rs`
...
- [ ] **T-004**: Implement `tasks::commit_frontmatter` -- body-byte-preserving rewrite
  ...
  - Suggested files: `crates/speccy-core/src/tasks.rs`, `crates/speccy-core/tests/tasks_commit.rs`
...
- [ ] **T-005**: Handle the bootstrap-pending sentinel and missing-frontmatter cases
  ...
  - Suggested files: `crates/speccy-core/src/tasks.rs` (extend), `crates/speccy-core/tests/tasks_commit.rs` (extend)
...
- [ ] **T-006**: Wire `--commit` sub-action through the CLI
  ...
  - Suggested files: `crates/speccy/src/tasks.rs` (extend), `crates/speccy/tests/tasks_commit.rs`
...
- [ ] **T-007**: Wire `speccy tasks SPEC-ID [--commit]` into the binary
  ...
  - Suggested files: `crates/speccy/src/main.rs`, `crates/speccy/tests/integration_tasks.rs`
...
- [ ] **T-008**: Self-referential dogfood test: commit SPEC-0006's own TASKS.md
  ...
  - Suggested files: `crates/speccy/tests/dogfood_self_commit.rs`
