---
spec: SPEC-0019
spec_hash_at_generation: 00c4c70fb0b4bf5577d03ca4c99a545966c5bab267b85061bc5f0c77aa35202b
...
- [x] **T-001**: Marker scanner, `SpecDoc` model, and strict parser
...
- [x] **T-002**: Deterministic renderer and parse/render/parse roundtrip
  - Covers: REQ-003
  - Tests to write:
...
- [x] **T-003**: `xtask/migrate-spec-markers-0019` rewrites one spec
  - Covers: REQ-004
  - Tests to write:
...
- [x] **T-004**: Run migration across every in-tree spec
  - Covers: REQ-004
  - Tests to write:
...
- [x] **T-005**: Workspace loader uses `SpecDoc`; spec.toml types deleted
  - Covers: REQ-002
  - Tests to write:
...
- [x] **T-006**: `speccy check`, `verify`, and prompt slicing read `SpecDoc`
  - Covers: REQ-005
  - Tests to write:
...
- [x] **T-007**: Sweep architecture, skills, and delete the migration tool
