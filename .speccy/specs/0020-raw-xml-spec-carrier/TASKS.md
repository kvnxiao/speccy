...
- [x] **T-001**: XML element scanner, `SpecDoc` model, and strict parser
...
- [x] **T-002**: Deterministic XML renderer and parse/render/parse roundtrip
...
- [x] **T-003**: `xtask/migrate-spec-xml-0020` rewrites one spec
  - Covers: REQ-004
  - Tests to write:
...
- [x] **T-005**: Workspace loader, lint, `speccy check`, `speccy verify` consume `spec_xml`; legacy marker parser deleted
  - Covers: REQ-002, REQ-003
  - Tests to write:
...
- [x] **T-006**: Prompt slicing, implementer prompt, reviewer prompt read XML `SpecDoc`
...
- [x] **T-007**: Sweep ARCHITECTURE.md, prompts, skills; delete the migration tool
